...
void Start::verifyFiles()
{
	...
	if (!canCreateFileInPath(params.stage1ParamsTemplate.GetTmpPath()))
	{
		std::cerr << "Error: Cannot create file in specified working directory: " << params.stage1ParamsTemplate.GetTmpPath() << "." << std::endl;
